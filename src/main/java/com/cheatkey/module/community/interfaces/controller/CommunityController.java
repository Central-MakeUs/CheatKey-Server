...
public class CommunityController {
    ...
    @Operation(summary = "게시글 신고", description = "게시글을 신고합니다. 신고 사유 코드는 t_code 테이블의 REPORT 그룹 코드 사용.")
    @ApiResponses({
    ...
    @Operation(summary = "게시글 작성자 차단", description = "특정 게시글 작성자를 차단합니다. 차단자는 해당 유저의 모든 게시글을 볼 수 없습니다.")
    @ApiResponses({
