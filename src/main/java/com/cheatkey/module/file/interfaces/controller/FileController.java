...
import com.cheatkey.module.file.interfaces.dto.FileUploadRequest;
...
public class FileController {
    ...
    @ApiResponses({
            ...
            @ApiResponse(responseCode = "400", description = "잘못된 요청 (빈 파일, 파일 크기 초과, 지원하지 않는 파일 형식)"),
    ...
    @ApiResponses({
            ...
            @ApiResponse(responseCode = "500", description = "서버 내부 오류 (Presigned URL 생성 실패)")
    })
    ...
    @ApiResponses({
            ...
            @ApiResponse(responseCode = "400", description = "잘못된 요청 (임시 파일 접근 시도)"),
            @ApiResponse(responseCode = "404", description = "파일을 찾을 수 없음"),
            @ApiResponse(responseCode = "500", description = "서버 내부 오류 (Presigned URL 생성 실패)")
    })
    ...
    @ApiResponses({
            ...
            @ApiResponse(responseCode = "400", description = "잘못된 요청"),
            @ApiResponse(responseCode = "404", description = "파일을 찾을 수 없음"),
            @ApiResponse(responseCode = "500", description = "서버 내부 오류 (파일 삭제 실패)")
    })
